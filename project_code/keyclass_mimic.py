...
# ---------------------------------------------------------------------------- #      
def load_data(train_path = '../data/icd9NotesDataTable_train.csv', 
              test_path = '../data/icd9NotesDataTable_valid.csv', 
              out_path = '../data/mimic/', 
              max_length = 1000, 
              random_state = 1234, 
              sample_size = 0.1):
    ...
    codeIdx = 9
    textIdx = 6
    helper.load_and_process_data(train_path, 
                                test_path, 
                                out_path, 
...
def train_lf(args, train_labels_filename):
    ...
    if training_labels_present:
        ...
        # Log the metrics
        training_metrics_with_gt = helper.compute_metrics(y_preds=y_train_pred, y_true=y_train, average=args['average'])
        helper.log(metrics=training_metrics_with_gt, filename='label_model_with_ground_truth', 
