...
notes = as_tibble(fread('/Users/minzhu/Desktop/DLH/DLH_2023_keyclass/KeyClass/data/NOTEEVENTS.csv'))# actual file use when testing is done
...
diagnoses = as_tibble(fread('/Users/minzhu/Desktop/DLH/DLH_2023_keyclass/KeyClass/data/DIAGNOSES_ICD.csv'))
...
diagnoses = group_by(diagnoses, .dots=c("HADM_ID","SUBJECT_ID"))
...
notes = mutate(notes, HADM_ID = strtoi(HADM_ID))
notes = group_by(notes, .dots=c("HADM_ID"))
...
# Write to file
##################################################################################
write.csv(icd9NotesDataTable, '/Users/minzhu/Desktop/DLH/DLH_2023_keyclass/KeyClass/data/icd9NotesDataTable.csv')
write.csv(icd9NotesDataTable_train, '/Users/minzhu/Desktop/DLH/DLH_2023_keyclass/KeyClass/data/icd9NotesDataTable_train.csv')
write.csv(icd9NotesDataTable_valid, '/Users/minzhu/Desktop/DLH/DLH_2023_keyclass/KeyClass/data/icd9NotesDataTable_valid.csv')
